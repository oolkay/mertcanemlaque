...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="padding: 0;width: 100%; background-color: #f7f7f7; -webkit-text-size-adjust: none;">
    <div id="wrapper" dir="ltr" style="max-width: 600px; width:calc(100% - 30px); background-color: #fff; margin: 0 auto;border: 1px solid #dedede;box-shadow: 0 1px 4px rgb(0 0 0 / 10%);">
        ...
        <div class=" body" style="padding: 48px 48px;color: #636363; font-size: 14px;font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
            ...
            <p>
                <?php echo esc_html__('Visitor changed reservation on listing', 'wpdirectorykit'); ?> <a href="<?php echo esc_url(get_permalink($listing)); ?>"><?php echo esc_html(wmvc_show_data('post_title', $listing, '', TRUE, TRUE)); ?></a>
            </p>
            ...
            <?php if(function_exists('wdk_dash_url')):?>
                <p>
                    <a href="<?php echo esc_url(wdk_dash_url('dash_page=booking-reservations&function=edit&id='.wmvc_show_data ('idreservation', $reservation, false, TRUE, TRUE)));?>"><?php echo esc_html__('Edit Reservation', 'wpdirectorykit'); ?></a>
                </p>
            <?php endif; ?>
            ...
            <ul class="wdk-list" style="margin:0;padding: 0;list-style: none;">
                <?php if(wmvc_show_data('display_name', $user_visitor, false, TRUE, TRUE)):?>
                    <li style="margin-bottom: 4px;" class="meta-item"><strong><?php echo esc_html__('Name', 'wpdirectorykit'); ?>:</strong> <?php echo esc_html(wmvc_show_data('display_name', $user_visitor, false, TRUE, TRUE));?></li>
                <?php endif;?>
                <?php if(wmvc_show_data('wdk_phone', $user_visitor, false, TRUE, TRUE)):?>
                    <li style="margin-bottom: 4px;" class="meta-item"><strong><?php echo esc_html__('Phone', 'wpdirectorykit'); ?>:</strong> <a href="tel:<?php echo esc_attr(wdk_filter_phone(wmvc_show_data('wdk_phone', $user_visitor, false, TRUE, TRUE)));?>"><?php echo esc_html(wmvc_show_data('wdk_phone', $user_visitor, false, TRUE, TRUE));?></a></li>
                <?php endif;?>
                <?php if(wmvc_show_data('user_email', $user_visitor, false, TRUE, TRUE)):?>
                    <li style="margin-bottom: 4px;" class="meta-item"><strong><?php echo esc_html__('Email', 'wpdirectorykit'); ?>:</strong> <a href="mailto:<?php echo esc_attr(wmvc_show_data('user_email', $user_visitor, false, TRUE, TRUE));?>"><?php echo esc_html(wmvc_show_data('user_email', $user_visitor, false, TRUE, TRUE));?></a></li>
                <?php endif;?>
                <?php if(wmvc_show_data('wdk_address', $user_visitor, false, TRUE, TRUE)):?>

...
<head>
  ...
  <title><?php echo esc_html__('Your Reservation Waiting For Approvement', 'wpdirectorykit'); ?></title>
  ...
  <div id="wrapper" dir="ltr" style="max-width: 600px; width:calc(100% - 30px); background-color: #fff; margin: 0 auto;border: 1px solid #dedede;box-shadow: 0 1px 4px rgb(0 0 0 / 10%);">
    ...
    <div class="header" style="background-color: #2671cb;padding: 48px 48px;color: #FFF;">
      <h2 style="margin:0;font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #ab79a1; color: #ffffff; background-color: inherit;"">
          <?php echo esc_html__('Your Reservation Waiting For Approvement', 'wpdirectorykit'); ?>
          </h2>
        </div>
        ...
        <p>
          <?php echo esc_html__('We received reservation for listing', 'wpdirectorykit'); ?> <a href="<?php echo esc_url(get_permalink($listing)); ?>"><?php echo esc_html( wmvc_show_data('post_title', $listing, '', TRUE, TRUE) ); ?></a>
        </p>
        <p>
          <?php echo esc_html__('Reservation waiting for approvement, we will inform you on approvement or owner will contact you', 'wpdirectorykit'); ?>
        </p>

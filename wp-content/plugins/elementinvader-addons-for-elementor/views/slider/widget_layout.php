<div class="widget-eli eli_slider" id="eli_<?php echo esc_html($this->get_id_int());?>">
    <div class="eli_container">
        <div class="ili_slider_box <?php echo $settings['t_options_slider_animation_style'].'_animation';?> <?php echo join(' ', [$settings['t_styles_dots_position_style'], $settings['t_styles_arrows_position_style'],$settings['t_styles_arrows_position'],$settings['t_styles_arrows_position_style']]);?>">
            <div class="eli_slider_ini  <?php esc_elemviewe($settings['t_styles_img_des_type']);?> ">
                <?php foreach ($results as $key => $item):?>
                    <div class="eli_s_item">
                        ...
                        <div class="eli_s_item_box_line"> <div class="eli_s_item_box_title"> <?php esc_elemviewe($item['title']);?> </div></div>
                        <?php endif;?>
                        <?php if(!empty($item['description'])):?>
                        <div class="eli_s_item_box_line"> <div class="eli_s_item_box_content"> <?php esc_elemviewe($item['description']);?> </div></div>
                        <?php endif;?>
                        <?php if(!empty($item['link'])):?>
                        <div class="eli_s_item_box_line"> <a class="eli_s_item_box_link" href="<?php esc_elemviewe($item['link']);?>"> <?php esc_elemviewe($settings['t_content_basic_link_text']);?> </a></div>
                        <?php endif;?>
                    </div>
                <?php endforeach;?>
                <?php if(false):?>
                <div class="eli_s_item">
                    ...
                    <div class="eli_s_item_box_line"> <div class="eli_s_item_box_title"> Title </div></div>
                    <div class="eli_s_item_box_line"> <div class="eli_s_item_box_content"> Text Text </div></div>

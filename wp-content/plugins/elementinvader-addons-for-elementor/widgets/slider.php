    ...
    if(true){
            ...
            $this->add_responsive_control(
               ...
               [
                   ...
                   'size_units' => [ 'px', 'vw','%' ],
                   'selectors' => [
                        '{{WRAPPER}} .eli_slider .eli_slider_ini .eli_s_item_box_line .eli_s_item_box_title' => 'max-width: {{SIZE}}{{UNIT}}',
                   ],
               ]
           );
            ...
            $this->add_responsive_control(
               ...
               [
                   ...
                   'size_units' => [ 'px', 'vw','%' ],
                   'selectors' => [
                        '{{WRAPPER}} .eli_slider .eli_slider_ini .eli_s_item_box_line .eli_s_item_box_content' => 'max-width: {{SIZE}}{{UNIT}}',
                   ],
               ]
           );
